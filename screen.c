...
/************************************************************
           Função tela indrodução de comandos
************************************************************/
...
/************************************************************
     Combinações de funcoes no mundo dos rectangulos
 ************************************************************/
...
/************************************************************
        Moviento de rectangulos para direita
 ************************************************************/
int _moveright(){
  int pos=-1;
  if (get_param(3)){
...
/************************************************************
        Moviento de rectangulos para esquerda 
 ************************************************************/
int _moveleft(){
  int pos=-1;
  if (get_param(3)){
