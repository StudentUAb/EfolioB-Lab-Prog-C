...
/*****************************************************************
    Função com gravidade onde an= altura nova é calculada e depois
    reduzida no ta=total altura, esse valor é o que faz o efeito 
    de redução do rectangulo ao chocar no chão
***********************************************************++++++*/
int gravidade(){
  int an=0;
  int ta;
  for (size_t i = 0; i < g._tam_uarray; i++) {
    while (1) {
      ...
      an++;
      ta=an*0.1;
      if( (limitey(g._u[i]->_y+ta, g._u[i]->_y+g._u[i]->_a-1)) || (colisao(g._u[i])) ){
        g._u[i]->_y++;
...
/************************************************************
 Função com rectangulo novo com novas dimesões nao terminada
************************************************************/
...
/************************************************************
    Função com rectangulo com caracter x
************************************************************/
...
/************************************************************
    Função com rectangulo com linhas
************************************************************/
...
/************************************************************
    Função limpa a tela com este printf com codificação 
    especial que podemos ver aprendendo sobre 
